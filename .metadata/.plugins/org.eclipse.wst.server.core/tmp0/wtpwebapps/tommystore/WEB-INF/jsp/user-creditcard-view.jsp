              ...
              <tbody>
		         <c:forEach var="creditCard" items="${creditCardList}">
			         <tr>
				         ...
				         <td>
				         	<a class="btn btn-dark" href="edit-creditcard-view?id=${creditCard.id}" role="button">Edit</a>
   				         	<a class="btn btn-dark" href="delete-credit-card?id=${creditCard.id}" role="button">Delete</a>
				         </td>
			         </tr>
		         </c:forEach>
              </tbody>
