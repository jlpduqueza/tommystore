...
<body data-context-path="${pageContext.request.contextPath}">
		...
		<div class="container" style="background-color:; max-width:1080px">
	        ...
	        <form:form action="add-to-cart" method="post" modelAttribute="cartItem">
			
			<div class="row">
				<div class="col-md-4">
					<div class="card" style="width: 9rem;">
					  <img src="/tommystore/images/${cartItem.product.picturePath}" class="card-img-top" alt="...">
					  <b><c:out value="${cartItem.product.name}"/></b>
					  <b><c:out value="${cartItem.product.price}"/></b>
					  <br>
<%--                 		<c:choose>
