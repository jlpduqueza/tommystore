...
<body data-context-path="${pageContext.request.contextPath}">
		...
		<div class="container" style="background-color:; max-width:1080px">
	        ...
	        <form:form action="add-credit-card" method="post" modelAttribute="creditCardBean">
			
			<div class="row">
				<div class="col-md-4">
					<div class="form-group">
						<label for="role">Card Number</label>
			        	<form:input path="cardNumber" type="text" class="form-control" name="name" placeholder="name" required="required"/>
				...
				<div class="col-md-4">
					<div class="form-group">
			        	...
			        	<form:input path="securityCode" type="text" class="form-control" name="name" placeholder="name" required="required"/>
