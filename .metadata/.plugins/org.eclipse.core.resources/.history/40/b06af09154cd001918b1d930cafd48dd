              ...
              <tbody>
		         <c:forEach var="category" items="${categoryList}">
			         <tr>
				         ...
				         <td>
				         	<a class="btn btn-dark" href="edit-category-view?id=${category.id}" role="button">Edit</a>
   				         	<a class="btn btn-dark" href="delete-category?id=${category.id}" role="button">Delete</a>
				         </td>
			         </tr>
		         </c:forEach>
              </tbody>
